...
window.onload = function () {
 	...
 	var k1 = 0;                               // счетчик общего кол-ва ячеек в таблице месяца
...
} //************************  ф-ия сохранения записи окончание

		//************************  ф-ия удаления записи
		function delzapbegin(){
			} //************************окончание  ф-ии удаления записи окончание
		...
		function statistik(){
  			...
  			} //************************* ф-ия клика по значку статисти окончание
		...
		function myClik(){
			...
			//console.log ("288   ", ter1.length); 
  			...
  			var num = (y*7+x+1); // вычисляем порядковый номер ячейки
   			...
   			jacheka = num;
			}// окончание функции обработки клика по ячейкам календаря
		...
		function tablDen(metkaData){
     	 ...
     	 }// окончание функции заполнения таблички записей дня  